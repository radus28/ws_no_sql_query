...
((SELECT id FROM `vtiger_ws_operation_seq`), 'module', 'String', '1'),((SELECT id FROM `vtiger_ws_operation_seq`), 'andWhere', 'encoded', '2'),((SELECT id FROM `vtiger_ws_operation_seq`), 'orWhere', 'encoded', '3'); 
